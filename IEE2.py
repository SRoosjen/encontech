#same with IEE1 but with for loop instead of taking averages
...
t_min = 3000#8900#6150#3000
t_max = 3700#9700#7000#3700
...
data = {'Eff/Carnot eff ':100*np.average(eff)/np.average(Carnoteff)}
